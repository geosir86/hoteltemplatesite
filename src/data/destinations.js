...
export const DESTINATIONS = {
  ...
  greece: {
    ...
    details: { guests: 4, beds: 2, baths: 2, sqm: '140m²', rating: 5.0, reviews: 12 },
    amenities: [
      { icon: Waves, label: 'Infinity Pool' }, { icon: Shield, label: 'Privacy' },
      { icon: Coffee, label: 'Artisan' }, { icon: Wifi, label: 'Starlink' },
    ],
    content: {
      en: {
        name: 'Greece', title: 'The Santorini Estate', subtitle: 'Sculpted Solitude',
        location: 'Oia, Santorini',
        description: 'A geometric sanctuary carved into the volcanic cliffs of Oia. Where white stone meets the infinite Aegean blue.',
      },
      gr: {
        name: 'Ελλάδα', title: 'Το Κτήμα της Σαντορίνης', subtitle: 'Σμιλεμένη Μοναξιά',
        location: 'Οία, Σαντορίνη',
        description: 'Ένα γεωμετρικό καταφύγιο λαξευμένο στους ηφαιστειογενείς βράχους της Οίας.',
      },
    },
  },
};
