...
export default function ImmersiveSwitcher({ activeRegion, setActiveRegion, lang, setLang }) {
  return (
    ...
    >
      <div className="relative bg-black/60 backdrop-blur-2xl rounded-full p-1.5 flex items-center gap-0.5 border border-white/[0.12] shadow-[0_8px_40px_rgba(0,0,0,0.6)]">

        {/* Brand icon */}
        <div className="pl-3 pr-2 py-2 flex items-center gap-1.5 border-r border-white/[0.1]">
        ...
        <div className="flex items-center overflow-x-auto no-scrollbar">
          {versions.map((v) => (
            <button
              ...
              data-magnetic
              className={`relative flex-shrink-0 px-4 py-2 text-[10px] sm:text-[11px] font-medium tracking-[0.1em] uppercase transition-all duration-300 rounded-full
